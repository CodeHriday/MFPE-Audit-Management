...
public class JwtService {
	...
	@Value("${secretkey}")
    private String SECRETKEY;	//this is the secretkey value from the applications.properties file
	
	@Value("${tokenduration}")
	private int TOKENDURATION;	//this is the expiration value for the token from the application.properties file
